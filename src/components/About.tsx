    ...
    <section id="about" className="w-full flex flex-col overflow-hidden">
      ...
      <div className="flex flex-col md:flex-row w-full h-auto">
        <motion.div 
          ...
          className="w-full md:w-1/2 bg-[#088c34] p-10 md:p-16 flex flex-col items-center justify-center text-center text-white border-b-4 md:border-b-0 md:border-r border-[#dde7b3]/20 relative overflow-hidden"
        >
