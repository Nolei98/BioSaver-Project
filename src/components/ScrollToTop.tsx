    ...
    <AnimatePresence>
      {isVisible && (
        <motion.button
          ...
          onClick={scrollToTop}
          className="fixed bottom-6 right-6 md:bottom-10 md:right-10 z-50 p-3 md:p-4 rounded-full bg-[#084c20] text-white shadow-[0_8px_30px_rgb(0,0,0,0.3)] hover:bg-[#dde7b3] hover:text-[#084c20] hover:scale-110 active:scale-95 transition-all outline-none border-2 border-white/20 hover:border-[#084c20] flex items-center justify-center group"
